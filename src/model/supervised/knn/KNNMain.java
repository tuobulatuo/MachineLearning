...
public class KNNMain {
    ...
    public static void digitTest (double k, String kernelClassName, EstimateBy estimateMethod, SelectNeighborBy selectNeighborMethod) throws Exception {
        ...
        String path1 = "/Users/hanxuan/Dropbox/neu/fall15/machine learning/data/digits.mnist/txt.sample/train.txt";
        String sep = "\\s+";
        boolean hasHeader = false;
        boolean needBias = false;
        int m = 200;
        ...
        String path2 = "/Users/hanxuan/Dropbox/neu/fall15/machine learning/data/digits.mnist/txt.sample/test.txt";
        builder =
        ...
        KNN.SELECT_NEIGHBOR_BY = selectNeighborMethod;
        KNN knn = new KNN(kernelClassName);
        knn.initialize(train);
        knn.train();

        ClassificationEvaluator eva = new ClassificationEvaluator();

        eva.initialize(train, knn);
...
//        GaussianK.GAMMA = 3;
//        digitTest(1, kn2, EstimateBy.NEIGHBOR, SelectNeighborBy.RANK);  // 0.888
