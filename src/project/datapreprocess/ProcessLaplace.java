...
public class ProcessLaplace {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String raw = "/Users/hanxuan/Dropbox/neu/fall15/data mining/project/data/clean/laplace/data.all.raw.txt";
        String correct = "/Users/hanxuan/Dropbox/neu/fall15/data mining/project/data/clean/laplace/data.all.correct.txt";
        String expand = "/Users/hanxuan/Dropbox/neu/fall15/data mining/project/data/clean/laplace/data.all.expand.txt";
